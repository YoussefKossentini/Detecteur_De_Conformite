...
public class GenerateurIndexDouble implements GenerateurCandidat {
    ...
    // Méthodes d'accès pour debug / démonstration
    public Map<Integer, Map<Integer, List<Integer>>> getIndexCacheForDebug() {
        return this.indexCache;
    }

    public List<Name> getDerniereListeBForDebug() {
        return this.derniereListeB;
    }
}